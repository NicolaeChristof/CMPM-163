...
THREE.GPUParticleSystem = function ( options ) {
	...
	this.particleNoiseTex = this.PARTICLE_NOISE_TEXTURE || textureLoader.load( 'nathan2.jpg' );
	this.particleNoiseTex.wrapS = this.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	this.particleSpriteTex = this.PARTICLE_SPRITE_TEXTURE || textureLoader.load( 'nathan2.jpg' );
...
THREE.GPUParticleContainer = function ( maxParticles, particleSystem ) {
	...
	this.spawnParticle = function ( options ) {
		...
		color.r = 1.0; THREE.Math.clamp( color.r + particleSystem.random() * colorRandomness, 0, 1 );
		color.g = 0.4; THREE.Math.clamp( color.g + particleSystem.random() * colorRandomness, 0, 1 );
